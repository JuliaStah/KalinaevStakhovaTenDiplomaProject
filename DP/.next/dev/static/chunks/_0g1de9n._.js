...
function useSession() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSession.useEffect": ()=>{
            ...
            const fetchProfile = {
                "useSession.useEffect.fetchProfile": async (user)=>{
                    if (!user) {
                        setProfile(null);
                        return;
                    }
                    const { data, error } = await supabase.from("пользователи").select(`фио, email, phone, роль:роли(название), заблокирован`).eq("email", user.email).single();
                    if (!error && data) setProfile(data);
                }
            }["useSession.useEffect.fetchProfile"];
            supabase.auth.getSession().then({
                "useSession.useEffect": ({ data: { session } })=>{
                    setSession(session);
            ...
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "useSession.useEffect": async (_event, session)=>{
                    setSession(session);
            ...
            return ({
                "useSession.useEffect": ()=>subscription.unsubscribe()
            })["useSession.useEffect"];
        }
    }["useSession.useEffect"], []);
    const isBlocked = profile?.заблокирован || false;
...
_s(useSession, "2PwuXsbjoKdj5teh7kEvBd7NSbE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
;
;
function Header({ navLinks = [], extraDropdownItems = [] }) {
    _s();
    ...
    const { session, profile, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSession"])();
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabaseBrowserClient"])();
    // Реальные данные пользователя
    const userName = profile?.фио || session?.user?.email?.split("@")[0] || "Гость";
    const initials = userName.trim().substring(0, 2).toUpperCase();
    const userEmail = session?.user?.email || "";
    const role = profile?.роль?.название || "Читатель";
    // Выход из аккаунта
    ...
    // Закрытие дропдаунов при клике вне хедера
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    extraDropdownItems.map((item, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            className: "dropdown-item",
                                            onClick: ()=>{
                                                item.onClick?.();
                                                setProfileOpen(false);
...
_s(Header, "IBD2EO3s9L4hSoeGfKzVlP0+QOk=", false, function() {
    return [
...
_s(DashboardPage, "G5B8TfaRU23KpcKWc0H4AVDSLuI=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_0g1de9n._.js.map